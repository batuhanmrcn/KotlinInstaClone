    package com.example.instagramkotlinclone
...
import com.example.instagramkotlinclone.databinding.ActivityUploadBinding
    ...
    fun upload(view : View){
        ...
        if (selectedPicture != null){
            ...
            imageReference.putFile(selectedPicture!!).addOnSuccessListener {
                ...
                val uploadPictures = storage.reference.child("images").child(imageName)
                uploadPictures.downloadUrl.addOnSuccessListener {
